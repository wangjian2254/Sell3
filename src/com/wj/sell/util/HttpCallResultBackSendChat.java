 ...
 */
public class HttpCallResultBackSendChat extends HttpCallResultBackBase {

    public HttpCallResultBackSendChat(HttpCallResultBack callResultBack) {
