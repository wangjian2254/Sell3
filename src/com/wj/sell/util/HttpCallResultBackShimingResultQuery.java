 ...
 */
public class HttpCallResultBackShimingResultQuery extends HttpCallResultBackBase {

    public HttpCallResultBackShimingResultQuery(HttpCallResultBack callResultBack) {
    ...
    protected String http_api() {
            return "app/query_self_realname_count";
    }
